...
const localRegistryWithoutProtocol = 'localhost:4873'
const localRgistry = `http://${localRegistryWithoutProtocol}`
...
execSync(`npm publish --access public --tag ${tag} ${tag === 'local' ? `--registry ${localRgistry}` : ''}`)
